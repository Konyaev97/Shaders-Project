Shader "z/Test3"
{
	...
	SubShader {
		CGPROGRAM
		#pragma surface surf StandardSpecular // описали тип Ўейдера (—урфействного типа) его описание в функции surf.
		...
		void surf (Input IN, inout SurfaceOutputStandardSpecular o) //создаем переменные, задает IN , возвращает значение o
		{
