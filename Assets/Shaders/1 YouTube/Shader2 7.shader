Shader "z/Test3"
{
	...
	SubShader {
		CGPROGRAM
		#pragma surface surf Standard // описали тип Ўейдера (—урфействного типа) его описание в функции surf.
		...
		void surf (Input IN, inout SurfaceOutputStandard o) //создаем переменные, задает IN , возвращает значение o
		{
